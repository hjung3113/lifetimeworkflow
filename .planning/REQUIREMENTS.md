...
- [ ] **RTA-02**: `/adopt` discover 단계가 실제 pnpm 워크스페이스 멤버 5개(root · `packages/ui` ·
...
- [ ] **RTA-04**: 도입 후 타깃의 각 패키지가 lint/test 커맨드를 포함한 nearest-wins 컨벤션 프로파일을
  갖는다.
...
- [ ] **OBS-02**: 관측 결함 중 목적 ①②③④(패키지별 컨벤션 / 패키지 간 계약 / LLM의 크로스-프로젝트
