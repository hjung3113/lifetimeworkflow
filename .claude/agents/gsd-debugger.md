...
<required_reading>
@/home/user/lifetimeworkflow/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/lifetimeworkflow/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/lifetimeworkflow/.claude
                  → checks /home/user/lifetimeworkflow/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/lifetimeworkflow/.claude/get-shit-done
                  → writes to /home/user/lifetimeworkflow/.claude/get-shit-done/hooks/
...
@/home/user/lifetimeworkflow/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/lifetimeworkflow/.claude/get-shit-done/references/common-bug-patterns.md
