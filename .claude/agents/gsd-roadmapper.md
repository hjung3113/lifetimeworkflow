...
Reference full template: `/home/user/lifetimeworkflow/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/lifetimeworkflow/.claude/get-shit-done/templates/state.md`.
