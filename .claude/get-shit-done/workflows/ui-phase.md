...
```markdown
Read /home/user/lifetimeworkflow/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/lifetimeworkflow/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/lifetimeworkflow/.claude/agents/gsd-ui-checker.md for instructions.
