...
```
Agent(
  prompt="Read /home/user/lifetimeworkflow/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/lifetimeworkflow/.claude/get-shit-done/templates/VALIDATION.md`
