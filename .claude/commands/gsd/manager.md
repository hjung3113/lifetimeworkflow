...
<execution_context>
@/home/user/lifetimeworkflow/.claude/get-shit-done/workflows/manager.md
...
Read and execute `/home/user/lifetimeworkflow/.claude/get-shit-done/workflows/analyze-dependencies.md` end-to-end.
