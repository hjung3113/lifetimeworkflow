...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/lifetimeworkflow/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/home/user/lifetimeworkflow/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/home/user/lifetimeworkflow/.claude/commands/gsd
AGENTS_DIR=/home/user/lifetimeworkflow/.claude/agents
```
...
<execution_context>
Surface state file: `/home/user/lifetimeworkflow/.claude/skills/.gsd-surface.json`
Install profile marker: `/home/user/lifetimeworkflow/.claude/skills/.gsd-profile`
Engine module: `/home/user/lifetimeworkflow/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/user/lifetimeworkflow/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
