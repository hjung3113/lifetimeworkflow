...
The opencode + Claude runtime surface (agents, commands, skills, plugins, `opencode.json`) is generated from the runtime-neutral `harness/` source by `tools.harness_emit`. See root `AGENTS.md` for the emitted index; do not hand-edit the generated `.opencode/` / `.claude/` trees.
<!-- END HARNESS-MANAGED -->
