---
description: >-
  Use at the start of a session to get oriented — regenerates the derived memory plane (repo-map,
  contracts-index) and prints the same pointer-only, drift-aware payload the SessionStart injector
  assembles, plus the read-order. Invoke when onboarding to the repo or resuming cold.
agent: orchestrator
subtask: true
---
