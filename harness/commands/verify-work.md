...
description: >-
  ...
  full tests, contract validation + drift, and the golden cases. Invoke as the pre-handoff
...
through `python -m tools.evidence.capture --task-dir <task-dir> --gate <gate> -- <existing argv>`.
