...
description: "Use when starting or resuming a task phase: fail closed on repository identity, state revision, required artifacts, blockers, and deterministic constraint-attestation coverage."
agent: orchestrator
---
