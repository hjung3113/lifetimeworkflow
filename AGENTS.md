...
- **Commands** (`.opencode/command/` · `.claude/commands/`): add-language, adr, build, checkpoint, component, contract-check, docs-sync, golden, golden-approve, lint, new-contract-rule, orient, pipeline, refresh-memory, review, strangler-step, test, verify-work
